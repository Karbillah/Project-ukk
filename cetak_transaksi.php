...
<body>
  ...
  <page size="dipakai" layout="landscape">
    ...
    <?php
      ...
      $query_order = "select * from `order` left join user on order.id_user = user.id_user where id_order = $id_order";
            ...
            <hr>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $no_order_fiks = 1;
                    $query_order_fiks = "select * from pesan natural join masakan where id_order = $id_order";
                  ...
                  <?php
                    ...
                    $query_harga = "select * from `order` where id_order = $id_order";
