        ...
        <div class="widget-content" >
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br></br>";
              $jumlah_terjual = 0; // Tambahkan inisialisasi variabel
              $status_masakan = ''; // Tambahkan inisialisasi variabel
              $query_tambah_masakan = "INSERT INTO masakan (nama_masakan, harga, gambar_masakan) VALUES ('$nama_masakan', '$harga', '$gambar')";
            ...
            if(isset($_POST['ubah_menu'])){
              ...
              $query_ubah_masakan = "update masakan set nama_masakan = '$nama_masakan', harga = '$harga', jumlah_terjual = '$jumlah_terjual', status_masakan = '$status_masakan' where id_masakan = '$id_masakan'";
              ...
              if($gbr != "" || $gbr != null){
                ...
                $query_ubah_gambar = "update masakan set gambar_masakan = '$gambar' where id_masakan = '$id_masakan'";;
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Carva </div>
</div>
