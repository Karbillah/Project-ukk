...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    ?>
      ...
      <?php
        $order = array();
        $query_lihat_order = "select * from `order`";
        ...
        while($r_dt_order = mysqli_fetch_array($sql_lihat_order)){
          if($r_dt_order['status_order'] != 'sudah bayar'){
            array_push($order, $r_dt_order['id_user']);
          }
        }
        ...
        <div class="widget-box span12">
          ...
          <div class="widget-content">
            <div class="alert alert-info alert-block">
              ...
              Silahkan tunggu pesanan tiba di meja Anda. Apabila selesai menyantap hidangan, silahkan lakukan proses pembayaran di kasir !
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from pesan natural join masakan where id_user = $id and status_pesan != 'sudah'";
                ...
                <?php
                  ...
                  $query_harga = "select * from `order` where id_user = $id and status_order = 'belum bayar'";
    ...
    <div class="row-fluid">
              ...
              <div class="btn-icon-pg">
                <ul>
                  ...
                  <?php
                    ...
                    $query_lihat_pesan = "select * from pesan where id_user = $id and status_pesan != 'sudah'";
                  ...
                  ?>
                    ...
                    <?php
                      ...
                      if(isset($_REQUEST['tambah_pesan'])){
                        ...
                        $query_tambah_pesan = "insert into pesan values('', '$id', '', '$id_masakan', '', '')";
                        $sql_tambah_pesan= mysqli_query($conn, $query_tambah_pesan);

                        $query_lihat_pesannya = "select * from pesan order by id_pesan desc limit 1";
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
              <?php
                $query_draft_pesan = "select * from pesan natural join masakan where id_user = $id and status_pesan != 'sudah'";
      ...
      <?php
          ...
          if(isset($_POST['hapus_pesan'])){
            ...
            $query_hapus_pesan = "delete from pesan where id_pesan = $id_pesan";
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $time = Date('YmdHis');
            echo $time;
            $query_simpan_order = "insert into `order` values('', '$id_admin', '$id_user', $time, '$no_meja', '$total_harga', '$uang_bayar', '$uang_kembali', '$status_order')";
            $sql_simpan_order = mysqli_query($conn, $query_simpan_order);

            $query_tampil_order = "select * from `order` where id_user = $id order by id_order desc limit 1";
            ...
            $query_ubah_jumlah = "select * from pesan left join masakan on pesan.id_masakan = masakan.id_masakan where id_user = $id and status_pesan != 'sudah'";
            ...
            while ($r_ubah_jumlah = mysqli_fetch_array($sql_ubah_jumlah)) {
              ...
              //echo $tempe;
              $query_proses_ubah = "update pesan set jumlah = $tempe, id_order = $id_ordernya where id_masakan = $tahu and id_user = $id and status_pesan != 'sudah'";
