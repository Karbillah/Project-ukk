        ...
        <div class="widget-content" >
          <div class="row-fluid">
              ...
              <div class="widget-box">
                <div class="widget-content nopadding">
                  <ul class="site-stats quick-actions">
                    <li class="bg_lb"><i class="icon-user"></i> <strong><?php echo $result_adm['jumlah_adm']; ?></strong> <small>Admin</small></li>
            ...
            <!--DATA ADMIN-->
              <!-- <div class="widget-box">
                <?php
                  $query_data_adm = "SELECT * FROM user WHERE id_level = 1";
